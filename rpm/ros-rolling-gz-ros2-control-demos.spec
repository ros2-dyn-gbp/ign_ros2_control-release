...
%global pkg_name gz_ros2_control_demos
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-gz-ros2-control-demos
Version:        1.2.2
Release:        1%{?dist}
Summary:        ROS %{pkg_name} package

License:        Apache License 2.0
URL:            https://github.com/ros-controls/gz_ros2_control/blob/master/README.md
...
%changelog
* Fri Mar 22 2024 Alejandro Hernandez <ahcorde@osrfoundation.org> - 1.2.2-1
